...
<div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
                ...
                <div class="form-content">
                  <div class="login-form">
                    ...
                    <div class="input-boxes">
                      ...
                      <div class="text"><a href="#" id="forgotPassword">Forgot password?</a></div>
  ...
  <!-- New Forgot Password Modal here-->
  ...
  <button class="close-btn" id="closeForgotPasswordModal">&times;</button>
        ...
        <form action="" method="POST" autocomplete="">
            ...
            <div class="form-group">
                <button class="btn btn-primary btn-block" type="submit" name="check-email">Reset Password</button>
            </div>
        </form>
    </div>
    ...
    <script>
        // Opens modal for Forgot Password
