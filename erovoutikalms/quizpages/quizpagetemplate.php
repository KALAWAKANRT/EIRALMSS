...
<main>
    ...
    <form method="POST" action="" id="quizForm">
        <div class="tab-content"> 
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q1" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q1" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q1" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q1" value="d" class="answer"> Answer 4<br><br>
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q2" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q2" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q2" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q2" value="d" class="answer"> Answer 4<br><br>
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q3" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q3" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q3" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q3" value="d" class="answer"> Answer 4<br><br>  
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q4" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q4" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q4" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q4" value="d" class="answer"> Answer 4<br><br> 
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q5" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q5" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q5" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q5" value="d" class="answer"> Answer 4<br><br> 
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q6" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q6" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q6" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q6" value="d" class="answer"> Answer 4<br><br>
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q7" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q7" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q7" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q7" value="d" class="answer"> Answer 4<br><br> 
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q8" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q8" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q8" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q8" value="d" class="answer"> Answer 4<br><br> 
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q9" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q9" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q9" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q9" value="d" class="answer"> Answer 4<br><br>   
            ...
            <div class = "quizcontainer">
                ...
                <input type="radio" name="q10" value="a" class="answer"> Answer 1<br><br>
                <input type="radio" name="q10" value="b" class="answer"> Answer 2<br><br>
                <input type="radio" name="q10" value="c" class="answer"> Answer 3<br><br>
                <input type="radio" name="q10" value="d" class="answer"> Answer 4<br><br>  
    ...
    <div id="results" style="display:none;" class="results">
        ...
        <input type="hidden" name="quiz" value="quiz"> <?php //Change value here based on quiz number. For example
