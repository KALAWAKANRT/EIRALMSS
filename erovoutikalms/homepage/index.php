<?php require_once "../controllerUserData.php"; //This is the current main page
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>EIRA | Training Page</title>
            ...
            <nav class="navbar navbar-dark navbar-expand-lg py-0">
                ...
                <div class="collapse navbar-collapse bg-transparent">
                    <div class="navbar-nav ms-auto mx-xl-auto">
                        ...
                        <?php if(isset($_SESSION['email'])): ?> <!-- Only when Logged in-->
                            <span class="nav-item" onclick="document.getElementById('dashboard').submit();">Profiles</span>
                            <form id="dashboard" method="POST" autocomplete="off" style="display: none;">
                            <input type="hidden" name="dashboard" value="Dashboard">
                            </form>
                            <a href="../login-signup/logout-user.php" class="nav-item">Logout</a>
                        <?php else: ?><!-- Only when Logged Out-->
                            ...
                            <!--JAVASCRIPT COURSE-->
                                <div class="tab-pane container" id="javascript">
                                    ...
                                    <div class="button-width">
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="JAVASCRIPT">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="popup__wrapper">
                                <a class="popup__close" href="#"><i class="fa-regular fa-circle-xmark" aria-hidden="true"></i></a>
                                    ...
                                    <!--DATABASE COURSE-->
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="dbb">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white" >
                                        </form>
                                    </div>
                                        </div>
                                    <!--PHP COURSE-->
                                        <div class="tab-pane container active" id="php">
                                            ...
                                            <div class="course-width">
                                             ...
                                             <form method="post" action="" class="modal-btn">
                                             <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                            ...
                            <div class="popup__wrapper">
                                <a class="popup__close" href="#"><i class="fa-regular fa-circle-xmark" aria-hidden="true"></i></a>
                                    <nav>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="GAME DEVELOPMENT & ANIMATION">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="cisco">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="cloud">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="machine">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="linux">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="plc">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="plc2">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="tele">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                                        ...
                                        <form method="post" action="">
                                        <input type="submit" name="start" class="btn m-2" value="Payment" style="color: white">
                                        <input type="hidden" name="course" value="ips">;
                                        <input type="submit" name="start-course" class="btn m-2" value="Start Learning" style="color: white">
                                        </form>
                                    </div>
                                                </div>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <div class="p-5 bg-primary rounded contact-form">
                            ...
                            <div class="text-start">
                                <button class="btn text-white py-3 px-5" name="contact" type="submit">Send Message</button>
                            </div>
                        </div>
                        </form>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex hightech-link">
                        <a href="https://www.facebook.com/erovoutika" class="btn-light nav-fill btn btn-square rounded-circle me-2"><i class="fab fa-facebook-f text-primary"></i></a>
                        <a href="https://twitter.com/erovoutika?lang=en" class="btn-light nav-fill btn btn-square rounded-circle me-2"><i class="fab fa-twitter text-primary"></i></a>
                        <a href="https://www.linkedin.com/company/erovoutika/" class="btn-light nav-fill btn btn-square rounded-circle me-0"><i class="fab fa-linkedin-in text-primary"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <p class="h3 text-primary">Quick Links</p>
                    <div class="mt-4 d-flex flex-column short-link">
                        <a href="https://eira.erovoutika.ph/index.php" class="mb-2 text-white"><i class="fas fa-angle-right text-primary me-2"></i>Home</a>
                        <a href="#aboutus" class="mb-2 text-white"><i class="fas fa-angle-right text-primary me-2"></i>About</a>
                        <a href="#training" class="mb-2 text-white"><i class="fas fa-angle-right text-primary me-2"></i>Training</a>
                        <a href="#gallery" class="mb-2 text-white"><i class="fas fa-angle-right text-primary me-2"></i>Gallery</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
