    ...
    if ($res->num_rows > 0) {
        ...
        if (password_verify($password, $fetch_pass)) {
            ...
            $_SESSION['user_name'] = $fetch['name'];
                ...
                $code = rand(999999, 111111);
                $update_code = "UPDATE admin SET code = $code WHERE email = '$email'";
...
if (isset($_POST['check-email'])) {
    ...
    if(isset($_POST['check-reset-otp'])){
        ...
        if(mysqli_num_rows($code_res) > 0){
            ...
            $_SESSION['info'] = $info;
            header('location: add_admin_newpassword.php');
            exit();
        }else{
            $errors['otp-error'] = "You've entered incorrect code!";
        }
    ...
    $old_password_query = "SELECT password FROM admin WHERE email = '$email'";
    ...
    if($result && mysqli_num_rows($result) > 0) {
        ...
        elseif(preg_match('/^\d+$/', $password)) {
            ...
            if($run_query) {
                ...
                $_SESSION['info'] = $info;
                header('Location: add_admin_passwordchanged.php');
            } else {
